...
class Go2Leg:
    ...
    #     # Step 2: touch down
    #     self._move_fr_to(contact_q, t_move=0.4, kp=65.0, kd=5.0)
    ...
    #     # Step 4: retreat back
    #     self._move_fr_to(retreat_q, t_move=0.6, kp=55.0, kd=4.0)

    #     # Step 5: quick tap down
    #     self._move_fr_to([0.0, 0.0, -0.9], t_move=0.4, kp=65.0, kd=5.0)

    #     # Step 6: brief hold at contact
    #     t0 = time.time()
    #     while time.time() - t0 < 0.15:   # hold 150ms
    #         for j in range(3):
    #             i = j
    ...
    #     # Step 7: retreat back again
    #     self._move_fr_to([0.0, 0.0, -2.0], t_move=0.6, kp=55.0, kd=4.0)

    #     print("[INFO] FR double tap complete.")
    ...
    #     def fr_touch(self,
    #              contact_q=[0.0, 0.0, -1.2],
    #              hold_s=2.0,
    #              finished_q=[0.0, 1.0, -2.0]):
    #     print("[INFO] Performing FR light touch...")

    #     # move FR gently to contact
    #     self._move_fr_to(contact_q, t_move=1.2, kp=25.0, kd=2.0)
    ...
    #             self.cmd.motor_cmd[i].dq = 0.0
    #             self.cmd.motor_cmd[i].tau = 0.0
    #         self._lock_non_fr(kp=30.0, kd=2.0)
    #         self.send_cmd()
    #         time.sleep(0.01)

...
if __name__ == '__main__':
    ...
    go2_leg._move_all_to(go2_leg.laydownPos, t_move=1.5, hz=200, kp=55.0, kd=4.0)
    go2_leg._hold_current_Pos(t_lock_time=1.0)
    go2_leg._move_all_to(go2_leg._standPos, t_move=1.5, hz=200, kp=55.0, kd=4.0)
    go2_leg._hold_current_Pos(t_lock_time=1.5)
    go2_leg._move_all_to(go2_leg.laydownPos, t_move=1.5, hz=200, kp=55.0, kd=4.0)
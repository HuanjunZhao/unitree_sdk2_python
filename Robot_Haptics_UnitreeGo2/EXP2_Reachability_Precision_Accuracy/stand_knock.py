...
class Go2Leg:
    ...
    def fr_knock1(self):
        ...
        self._move_all_to(self.fr_contact, t_move=0.05, hz=200, kp=70.0, kd=5.0)
        self._hold_current_Pos(q_target= self.fr_contact1, t_lock_time=0.2)
    ...
    def fr_knock2(self):
        ...
        self._move_all_to(self.fr_contact, t_move=0.05, hz=200, kp=70.0, kd=5.0)
        self._hold_current_Pos(q_target= self.fr_contact2, t_lock_time=0.2)
    ...
    def fr_knock3(self):
        ...
        self._move_all_to(self.fr_contact, t_move=0.05, hz=200, kp=70.0, kd=5.0)
        self._hold_current_Pos(q_target= self.fr_contact3, t_lock_time=0.2)
    ...
    def fr_knock4(self):
        ...
        self._move_all_to(self.fr_contact, t_move=0.05, hz=200, kp=70.0, kd=5.0)
        self._hold_current_Pos(q_target= self.fr_contact4, t_lock_time=0.2)
    ...
    def fr_knock5(self):
        ...
        self._move_all_to(self.fr_contact, t_move=0.05, hz=200, kp=70.0, kd=5.0)
        self._hold_current_Pos(q_target= self.fr_contact5, t_lock_time=0.2)
    ...
    def fr_knock6(self):
        ...
        self._move_all_to(self.fr_contact, t_move=0.05, hz=200, kp=70.0, kd=5.0)
        self._hold_current_Pos(q_target= self.fr_contact6, t_lock_time=0.2)

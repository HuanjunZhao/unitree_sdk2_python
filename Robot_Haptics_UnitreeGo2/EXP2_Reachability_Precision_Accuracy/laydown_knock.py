...
if __name__ == '__main__':
    ...
    go2_leg._move_fr_to([-0.85, 1.25, -2.75], t_move=0.5, kp=60.0, kd=5.0)
    go2_leg._move_fr_to([-0.85, -1.4, -2.75], t_move=1.6)

    go2_leg.fr_knock(ready_q = [0, -1.35, -2.75], knock_q = [0, -1.35, -0.9])
    go2_leg.fr_knock(ready_q = [0, -1.30, -2.75], knock_q = [0, -1.30, -0.9])
    go2_leg.fr_knock(ready_q = [0, -1.25, -2.75], knock_q = [0, -1.25, -0.9])
    go2_leg.fr_knock(ready_q = [0, -1.20, -2.75], knock_q = [0, -1.20, -0.9])
    go2_leg.fr_knock(ready_q = [0, -1.15, -2.75], knock_q = [0, -1.15, -0.9])
    go2_leg.fr_knock(ready_q = [0, -1.10, -2.75], knock_q = [0, -1.10, -0.9])
            
    
    go2_leg._move_fr_to([0.0, -1.4, -2.75], t_move=0.8)
    time.sleep(0.1)
    go2_leg.fr_back_Pos()
